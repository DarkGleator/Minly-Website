function loadDynamicData() {
    ...
    var audioUrl = getParameterByName('audio');
    ...
    document.getElementById('dynamic-audio').src = audioUrl;
...
function redirectToDynamicAudioPage(projectName, personName, audioUrl) {
    ...
    // Redireciona para a página dinâmica do áudio
